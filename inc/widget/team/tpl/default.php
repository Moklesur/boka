...
<div class="row">
	<?php foreach( $instance['team'] as $i => $team ) : ?>
		<div class="boka-team-list col-md-<?php echo esc_attr( $instance['per_row'] ); ?> col-sm-<?php echo esc_attr( $instance['per_row'] ); ?> col-xs-12">
			<div class="boka-team-member">
				<div class="boka-image-container">
					<?php
					...
					?>
				</div><!-- .boka-image-container -->
				<div class="boka-info-container">
					<div class="">
