<div class="boka-fact-widget fact-list padding-gap-1 padding-gap-2 <?php echo $instance['heading_alignment']; ?>">
	...
	<?php endif; ?>
	<ul class="boka-fact-list position-relative list-inline">
