...
add_action( 'boka_header_social', 'boka_header_social_action' );

/**
 *  Footer Social
 */
function boka_footer_social_action() {
...
add_action( 'boka_footer_social', 'boka_footer_social_action' );
...
function boka_footer_copyright(){
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 site-info">
       <a href="<?php echo esc_url( __( 'https://www.themetim.com', 'boka' ) ); ?>">
           <?php
           echo __( get_theme_mod( 'copyright', 'Boka By ThemeTim' ), 'boka' );
           ?>
       </a>
    </div>
    <?php
