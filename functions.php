...
function boka_scripts() {
	...
	wp_enqueue_script( 'boka-jquery-mobile-customized', get_template_directory_uri() . '/assets/js/jquery.mobile.customized.min.js', array('jquery'), '1.4.5', true );
	wp_enqueue_script( 'boka-easing', get_template_directory_uri() . '/assets/js/jquery.easing.1.3.min.js', array('jquery'), '1.3', true );
	wp_enqueue_script( 'masonry', get_template_directory_uri() . '/assets/js/masonry.js', array('jquery'), '4.2.0', true );
	wp_enqueue_script( 'boka-camera', get_template_directory_uri() . '/assets/js/camera.min.js', array('jquery'), '1.3.4', true );
	wp_enqueue_script( 'boka-jquery-mousewheel', get_template_directory_uri() . '/assets/js/jquery.mousewheel.min.js', array('jquery'), '3.1.13', true );
	wp_enqueue_script( 'boka-jquery-simplr-smoothscroll', get_template_directory_uri() . '/assets/js/jquery.simplr.smoothscroll.min.js', array('jquery'), '1.0.1', true );
