...
<div id="comments" class="comments-area margin-top-30">
	...
	if ( have_comments() ) : ?>
		<h3 class="comments-title">
			<?php
			printf( // WPCS: XSS OK.
				esc_html( _nx( 'Comments', '%1$s %2$s', get_comments_number(), 'comments title', 'boka' ) ),
		...
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
			<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
				<div class="nav-links">
					...
					<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'boka' ) ); ?></div>
		...
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
			<nav id="comment-nav-below" class="navigation comment-navigation" role="navigation">
				<h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'boka' ); ?></h2>
				<div class="nav-links">
	...
	if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
		...
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'boka' ); ?></p>
		<?php
	endif;
	$comment_form = array(
		'id_form'           => 'commentform',
